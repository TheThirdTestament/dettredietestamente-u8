...
namespace DttInfo.Controllers
{
    public class NewsletterFormSurfaceController : SurfaceController
    {
        ...
        public ActionResult HandleFormSubmit(NewsletterRegistration model)
        {
            ...
            message.Subject = "Mail fra dettredietestamente.info: Tilmelding til nyhedsbrev";
            ...
            IContent msg = Services.ContentService.CreateContent(model.Firstname + " " + model.Lastname, currentPageUdi, "newsletterRegistration"); 
